...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add New Slider</button>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <?php if (empty($row['slider_image'])) : ?>
                                                            <img class="img-circle" width="50" src="/assets/backend/images/user_blank.png">
                                                        <?php else : ?>
                                                            <img class="img-circle" width="50" src="/assets/backend/images/slider/<?= $row['slider_image']; ?>">
                                                        <?php endif; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['slider_title']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['slider_subtitle']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['slider_link']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?= $row['slider_id']; ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                                <li><a href="javascript:void(0);" class="delete" data-userid="<?= $row['slider_id']; ?>"><span class="icon-trash"></span> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <!-- Modal Add-->
    <form id="add-row-form" action="/<?= session('role'); ?>/slider" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <textarea name="subtitle" class="form-control" rows="6" placeholder="Description of slider" required></textarea>
                                </div>
                                <div class="form-group">
    ...
    ?>
        ...
        <form id="add-row-form" action="/<?= session('role'); ?>/slider" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="ModalEdit<?= $row['slider_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify" data-height="180" data-default-file="/assets/backend/images/slider/<?= $row['slider_image']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" name="title" value="<?= $row['slider_title']; ?>" class="form-control" placeholder="Name" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="subtitle" class="form-control" rows="6" placeholder="Deskripsi" required><?= $row['slider_subtitle']; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="link" value="<?= $row['slider_link']; ?>" class="form-control" placeholder="Link" required>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="slider_id" value="<?= $row['slider_id']; ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
        ...
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Sliderr</h4>
                    </div>
                    <div class="modal-body">
                        <strong>Anda yakin mau menghapus slider ini?</strong>
                        <div class="form-group">

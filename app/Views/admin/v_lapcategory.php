...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                    ...
                                    <table id="data-table" class="display table" style="width: 100%; ">
                                        ...
                                        <tbody id="body-table">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td><?= $row['lapcategory_name']; ?></td>
                                                    <td><?= $row['lapcategory_slug']; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?= $row['lapcategory_id']; ?>" data-category="<?= $row['lapcategory_name']; ?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $row['lapcategory_id']; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="/<?= session('role'); ?>/lapcategory" method="POST">

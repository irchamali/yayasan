...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?= $row['aps_id']; ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                                <li><a href="javascript:void(0);" class="delete" data-userid="<?= $row['aps_id']; ?>"><span class="icon-trash"></span> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
    ...
    <!-- Modal Add-->
    <form id="add-row-form" action="/<?= session('role'); ?>/akreditasi" method="POST" enctype="multipart/form-data">
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Add Data Akreditasi</h4>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="prodi" required>
                                        <option value="">- Prodi Option-</option>
                                            <?php foreach ($studies as $row) : ?>
                                                <option value="<?= $row['prodi_id']; ?>"><?= $row['prodi_nama']; ?></option>
                                            <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="sk" class="form-control" placeholder="Nomor SK" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="tahun" class="form-control" placeholder="Tahun SK" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="peringkat" class="form-control" placeholder="Peringkat" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="kadaluarsa" class="form-control" placeholder="Kadaluarsa" required>
                                </div>
                                <div class="form-group">
    ...
    ?>
        ...
        <form id="add-row-form" action="/<?= session('role'); ?>/akreditasi" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="ModalEdit<?= $row['aps_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="sk" value="<?= $row['no_sk']; ?>" class="form-control" placeholder="Nomor SK" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="tahun" value="<?= $row['thn_sk']; ?>" class="form-control" placeholder="Tahun SK" required>
                                    </div>
                                    <div class="form-group">
        ...
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Data Akreditasi</h4>
                    </div>
                    <div class="modal-body">

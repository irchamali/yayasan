	...
	<div class="search-popup">
		...
		<form method="GET" action="/search">
			<div class="form-group">
				<input type="search" name="search_query" value="" placeholder="Search Here" required="">
				<button class="fa fa-solid fa-magnifying-glass fa-fw" type="submit" value="Search"></button>
			</div>
		</form>
	</div>
	<!-- End Search Popup -->
